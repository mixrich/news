...
EOF;
	...
	$rpl = array( '\\' => '\\\\', '"' => '\\"' ) ;
	echo $s='window.parent.OnUploadCompleted(new Array(\'' . implode("','",$errorNumber) . '\'),new Array(\'' . strtr( implode("','",$fileUrl), $rpl ) . '\'),new Array(\'' . strtr( implode("','",$fileName), $rpl ) . '\'), "' . strtr( $customMsg, $rpl ) . '") ;' ;
	echo '</script>' ;
	exit ;
}
