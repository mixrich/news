...
$Config['ThumbMaxGenerate'] = 10; // Максимальное количество превьюшек, генерируемое за раз, если вдруг их нет
...
$Config['UserFilesAbsolutePath'] = $_SERVER["DOCUMENT_ROOT"].'/data/' ;
